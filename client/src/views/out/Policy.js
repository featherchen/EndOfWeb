    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              this Agreement) refers to NTUEE+.
            </p>
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to NTUEE+, accessible from https://plus.ntuee.org/
          </li>{' '}
          <li>
        ...
        <p>
          ...
          as soon as You close your web browser. Learn more about cookies in the{' '}
        ...
        <ul>
          ...
          <li>By visiting this page on our website: https://plus.ntuee.org/Contact</li>
        </ul>
      </div>
    )
  }
