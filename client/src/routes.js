...
const routes_out = [
  ...
  {
    path: '/register_entry_student',
    exact: true,
    name: 'RegisterEntryStudent',
    component: RegisterEntryStudent,
  },
  {
    path: '/register_entry_alumni',
    exact: true,
    name: 'RegisterEntryAlumni',
    component: RegisterEntryAlumni,
  },
